         ...
         <nav id="sidebar">
            <div class="sidebar_blog_1">
               <div class="sidebar-header">
                  ...
                  <a href="index.php">
                  <img style="margin-left: 30px; margin-top: 25px; border-radius: 100px; width: 50px; height: 50px" src="uimages.png">
                  </div>
               </div>
         ...
         <div id="content">
            ...
            <div class = "box">
                ...
                <div class="course-listings">
                    <div class="course">
                        <a href="images\vid-1.mp4" target="_blank"><img src="images\Web.jpg" alt="it course1" style="width: 300px"></a>
                        <h2>Web developer</h2>
                    </div>
                 ...
                 <h6 >Upload contnet:<input type="file" name="UploadContent"></button>
